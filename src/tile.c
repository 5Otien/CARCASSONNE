	...
	if (couleurfond != 0){
		if(S.type == 'b'){
			...
			printf("\033[43");       // beige
                        ...
                        printf("\033[38;5;178"); // jaune foncé
		} else {
			printf("\033[40");       // noir
		}
		...
		{
		case 0:
			printf(" j \033[0m");          //jaune
			break;
		
		case 1:
			printf(" r \033[0m");          //rouge
			break;
		
		case 2:
			printf(" v \033[0m");          //vert
			break;
		
		case 3:
			printf(" b \033[0m");          //bleu
			break;
		
		case 4:
			printf(" c \033[0m");          //cyan
			break;
		
		case 5:
			printf(" m \033[0m");          //magenta
			break;
